...
def test_hello(exe_dir, output_dir):
    ...
    print("    no-raw test")
    retcode, time_taken = run_executable(
        [executable, "-t", "2000", "--no-raw"], logfile
    )
...
def test_still(exe_dir, output_dir):
    ...
    print("    no-raw test")
    retcode, time_taken = run_executable(
        [executable, "-t", "1000", "-o", output_jpg, "--no-raw"], logfile
    )
    ...
    print("    zsl test")
    retcode, time_taken = run_executable(
        [executable, "-t", "1000", "-o", output_jpg, "--zsl"], logfile
    )
    ...
    print("    metadata test")
    retcode, time_taken = run_executable(
        [executable, "-t", "1000", "-o", output_jpg, "--metadata", output_metadata],
        logfile,
    )
...
def test_vid(exe_dir, output_dir):
    ...
    print("    h264 test")
    retcode, time_taken = run_executable(
        [executable, "-t", "2000", "-o", output_h264], logfile
    )
    ...
    retcode, time_taken = run_executable(
        [executable, "-t", "2000", "-o", output_h264, "--no-raw"], logfile
    )
    ...
    print("    mjpeg test")
    retcode, time_taken = run_executable(
        [executable, "-t", "2000", "--codec", "mjpeg", "-o", output_mjpeg], logfile
    )
    ...
    print("    circular test")
    retcode, time_taken = run_executable(
        [executable, "-t", "2000", "--inline", "--circular", "-o", output_circular],
        logfile,
    )
    ...
    retcode, time_taken = run_executable(
        [executable, "-t", "2000", "-o", output_h264, "--save-pts", output_timestamps],
        logfile,
    )
